    ...
    """
        ...
        Args:
            ...
            dataset_name (list of str): The dataset to train on. Choices: (from the UCI dataset repository):
                "anions", "anions_0.02", "anions_0.05", "cations", "cations_0.02","cations_0.05", where the numbers
                (_0.02 and _0.05) are added the restrict the dataset to contain only features having an relative
                importance of at least (respectively) 2% and 5%.
